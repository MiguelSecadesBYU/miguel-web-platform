...
const SINOPSIS =
  "Un antiguo papiro hallado en Oriente Próximo revela la pista de un objeto que no debería existir: el Anillo de Salomón, capaz —según los textos— de doblegar la voluntad de los espíritus y revelar los secretos del universo. Cuando el arqueólogo Álvaro Ballester sigue su rastro, sus pasos se cruzan con los de Daniela Gil, una joven asturiana que acaba de recibir una herencia que la conecta con un secreto familiar de generaciones. Juntos se lanzan a una carrera contrarreloj desde Madrid hasta Jerusalén, las ruinas de Babilonia y la mítica Axum. Pero no son los únicos que buscan el anillo, y los que también lo buscan no están dispuestos a compartirlo.";
